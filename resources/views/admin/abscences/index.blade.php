@extends('admin.layouts.admin',['title'=>'Gestion des Presences' ])
@php
  ...
  <div class="col-md-12">
    ...
    <div class="row">
      <div class="col-12 float-right">
        <a href="{{ route('formations.index') }}" class="btn btn-info btn-sm">Agents en Formation</a>
        <a href="{{ route('abscences.index') }}" class="btn btn-success btn-sm">Agents en Activité</a>
      </div>
    </div>
