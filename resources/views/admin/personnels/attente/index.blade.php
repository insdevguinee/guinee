@extends('admin.layouts.admin',['title'=>'Effectif des Agents en attente ('.$stat['total_personnels'].')' ])
@section('content')
...
<div class="row">
  <div class="col-md-12">
     <div class="card">
      <div class="card-body">
        <div class="col-12">
            <form action="{{ route('personnels.attente') }}" method="GET" class="input-group no-border">
    ...
    <div class="card">
      <div class="card-body" style="background: cornsilk">
        <a href="{{ route('personnels.attente') }}" class="btn btn-success btn-sm">Effectif des agents en attente</a>
        <form action="{{ route('personnels.attente') }}" methode="GET" style="display: inline-flex;">
       ...
       <a href="{{ route('personnels.import.attente') }}" class="btn btn-info btn-sm float-right">
        Importer la liste des agents en attente <i class="fa fa-upload" aria-hidden="true"></i>
        </a>
              ...
              <tr>
                ...
                <td>
                  ...
                  @can('delete_personnels')                
                    {!! Form::open(['method' => 'PUT', 'route' => ['personnels.update', $personnel->id] ,'style'=>'display:inline-block !important;margin:0;']) !!}
                    <input  type="submit" class="btn btn-danger btn-sm" value="X" name='etat'>
                    {!! Form::close() !!}
                    {{--
