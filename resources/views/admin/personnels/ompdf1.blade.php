		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-6 text-right">
					...
					<p style="margin-bottom: 5px; font-size: 11px;">  Travail - Justice - Solidarité </p>
					<p style="margin-bottom: 5px; font-size: 11px;">  Conakry, le 1<sup>er</sup> Septembre 2023 </p>
				</div>
			</div>
						...
						<tbody>
							<tr>
								...
								<td>
									...
									<span class="text-uppercase">{{  @$personnel->nom.' '.@$personnel->prenoms }}</span> ({{ ucwords(@$personnel->fonction->libelle) }} / {{ @$personnel->unity }})<br>
									@endforeach

									@isset($conducteurs)
                                        @foreach ($conducteurs as $conducteur)
                                            <span class="text-uppercase">
                                            {{@$conducteur->name}} {{@$conducteur->last_name}}
                                            </span> (Chauffeur) <br/>
                                        @endforeach
									@endisset
								</td>
							...
							<tr>
								...
								<td>Sensibilisation de la Cartographie Censitaire Pilote</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>:
                                    @foreach ($conducteurs as $conducteur)
                                        {{@$conducteur->brand_car}} {{@$conducteur->number_car}},
                                    @endforeach
							...
							<tr>
								...
								<td>:
									...
									<span class="text-uppercase">{{ @$engin->brand.' '.@$engin->number }}</span>,
									@endforeach
								</td>
							</tr>
