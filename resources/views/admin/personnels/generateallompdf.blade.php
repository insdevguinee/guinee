	...
	<body>	
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-6">
					<div class="logo">
						<img src="{{ public_path('/img/drapeau-gn.png') }}" style="height: 100px">
						<img src="{{ public_path('/img/armoirie-gn.png') }}" style="height: 90px">
					</div>
				</div>

				<div class="col-md-6 text-right">
					<p style="margin-bottom: 5px; font-size: 17px;"><strong>REPUBLIQUE DE LA GUINEE</strong></p><div class="clearfix"></div>
					<p style="margin-bottom: 5px; font-size: 12px;">  Travail - Justice - Solidarité </p>
					<p style="margin-bottom: 5px; font-size: 12px;">  Conakry, le 1<sup>er</sup> Septembre 2023 </p>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">				
					...
					<div class="text-center">
						<H4 style="font-weight: 700;margin-bottom: 0px; font-size:32px;"><u>ORDRE DE MISSION</u></H4>
						<p style="margin-top: 0;font-size: 19px;">N° &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INS/DGA/DG/CTP/2023</p><br>
					</div>
				</div>
			</div>
			<div class="row">
						...
						<tbody>
							<tr>
								...
								<td> 
									...
									<span class="text-uppercase">{{  @$personnel->nom.' '.@$personnel->prenoms }}</span> ({{ ucwords(@$personnel->fonction->libelle) }})<br>
									@endforeach
								</td>
							</tr>
							<tr>
								<th>De se rendre à </th>
								<td class="text-uppercase">: {{ @$personnel->direction->libelle }}.</td>
							</tr>
							<tr>
			...
			<div class="row">
				<div class="col-12 text-right" style="font-size: 19px;">
					...
					<figure>
						<img src="{{ public_path('img/sign-dga.png') }}" alt="" style="width: 100px;margin-top: 10px">
						<img src="{{ public_path('img/cachet-dga.png') }}" alt="" style="width: 100px;margin-top: 10px">
					</figure>
					Mamadou CAMARA
				</div>
			</div>
