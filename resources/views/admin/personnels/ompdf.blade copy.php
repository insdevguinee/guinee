		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<div class="logo">
						<img src="{{ public_path('/img/am.jpg') }}" style="height: 70px">
					</div>
			...
			<div class="row" style="margin-top: 20px;">
				<div class="col-12">
					<div class="section">
						<img src="{{ public_path('/img/logo.png') }}" style="float: left; width:100px;" ><br>
					</div>
					<div class="section">
					<!--	<img src="{{ public_path('/img/logobtpr.png') }}" style="float: right; width:200px;" > -->
					</div>
				</div>
						...
						<tbody>
							<tr>
								...
								<td>: 
									...
									<span class="text-uppercase">{{  @$personnel->nom.' '.@$personnel->prenoms }}</span> ({{  @$personnel->fonction->libelle }})<br>
									@endforeach
								</td>
							</tr>
							<tr>
			...
			<div class="row">
			  ...
			  <div class="text-center float-right">
						...
						<img src="{{ public_path('img/signe2.png') }}" alt="" style="width: 200px;margin-top: 10px"> <br>
