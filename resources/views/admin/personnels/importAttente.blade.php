@extends('admin.layouts.admin',['title'=>'Importation de personnels en attente'])
@section('content')
{{-- <div class="row">
...
<div class="row d-flex justify-content-center mt-60">
    <div class="col-md-6 text-center">
      <form action="{{ route('personnels.post.attente') }}" class="dropzone dz-clickable"  method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="text-center m-t-20">
            <small class="d-block"><a href="{{ route('template.attente') }}">Template de remplissage </a></small>
