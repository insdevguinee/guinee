@extends('admin.layouts.admin',['title'=>'Enregistrement Comptable'])
@section('style')
              ...
              <tr>
                ...
                <td>
                  @if(!$caisse->parent_id) 
                    ...
                    @endcan
                    @can('delete_caisses')
                      {!! Form::open(['method' => 'DELETE', 'route' => ['caisses.destroy', $caisse->id] ,'style'=>'display:inline-block !important;margin:0;','onsubmit'=>'return show_alert();']) !!}
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('caisses.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="container">
              <div class="row">
