    ...
    <div class="card">
      <div class="card-body">
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            <?php $__currentLoopData = $fournisseur->caisses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caisse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <?php endif; ?>      
                <td><a href="<?php echo e(route('caisses.edit',[$caisse->id])); ?>" title="Modifier">M<i class="fa fa-edit"></i></a></td>
              </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </tbody>
          </table>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo e(route('caisses.store')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <div class="container">
              <div class="row">
...
if (isset($messageCache)) { $message = $messageCache; }
                ...
                <div class="form-group col-md-6" >  <label for="ligne_budget">Ligne budget</label>
                 ...
                 <input required value="<?php echo e(old('ligne_budget')); ?>" autocomplete="off" class="form-control  <?php if ($errors->has('ligne_budget')) :
if (isset($message)) { $messageCache = $message; }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin',['title'=>'Caisse '.$fournisseur->name], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/6ec092764b90fcd42777971432306baa/sites/recensement-2021.com/resources/views/admin/fournisseurs/show.blade.php ENDPATH**/ ?>