      ...
      <div class="card card-stats">
        <div class="card-body alert-info " style="    border-radius: 12px;">
          <div class="row">
            ...
            <div class="col-7 col-md-8">
              <div class="numbers">
                <p class="card-category"><?php echo e($etat['solde'] - $etat['debit']); ?></p>
                <small style="position: absolute; left: -70px; bottom: 0px; font-size: 11px;"><strong>Caisse : </strong><?php echo e($etat['solde']); ?></small>
        ...
        <div class="col-md-3">
            ...
            <label for="">Sous Préfecture</label>
             <select class="form-control" name="direction" >
                <option value="">Toutes les Sous Préfecture</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin',['title'=>'Gestion de depense'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/recensement-2021.com/resources/views/admin/depenses/index.blade.php ENDPATH**/ ?>