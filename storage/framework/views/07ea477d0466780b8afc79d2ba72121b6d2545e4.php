	...
	<body>
		<div class="container-fluid">
			<div class="row">
				<div class="col-3">
					<div class="logo">
						<img src="<?php echo e(public_path('/img/partenaires/logo.png')); ?>" alt="logo" style="width: 100px">
					</div>
				</div>
				...
				<div class="col-12">
					<div class="text float-left">
						<strong>
							...
							<img src="<?php echo e(public_path('img/signe2.png')); ?>" alt="" style="width: 100px;margin-top: 10px;"><br>
...
<?php /**PATH /home/diatas/Bureau/INS/app/guinee/resources/views/admin/paies/pdf.blade.php ENDPATH**/ ?>