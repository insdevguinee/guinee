  ...
  <div class="col-md-12">
    ...
    <div class="card">
      <div class="card-body" style="background: cornsilk">
       ...
       <a href="<?php echo e(route('personnels.import.attente')); ?>" class="btn btn-info btn-sm float-right">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin',['title'=>'Effectif des Agents en attente ('.$stat['total_personnels'].')' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DIATAS\Desktop\DIATAS\INS\app\guinee\resources\views/admin/personnels/attente/index.blade.php ENDPATH**/ ?>