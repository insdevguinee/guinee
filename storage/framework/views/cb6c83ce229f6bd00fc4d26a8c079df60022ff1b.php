        ...
        <table class="table table-bordered table-hover table-responsive" id="table_id">
          <thead>
            <tr class="text-capitalize">
              ...
              <?php if(@$_GET['personnel'] != 'formations'): ?>
          ...
          <tbody>
            ...
            <tr class="personnel">
              <td><?php echo e($personnel['matricule']); ?>
              ...
              <?php if($personnel['etat'] == 2): ?>
              <td><?php echo e(\App\Option::calcul_frais_mtn( $personnel['salaireformation'])); ?> </td>
              <?php else: ?>
...
<?php echo $__env->make('admin.layouts.admin',['title'=>'Paiement' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/guinee/resources/views/admin/paies/index.blade.php ENDPATH**/ ?>