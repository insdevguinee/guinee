...
<div class="row">
  ...
  <div class="col-12 float-right">
    <a href="<?php echo e(route('personnels.index')); ?>" class="btn btn-success btn-sm">Personnel Actif</a>
    <a href="<?php echo e(route('personnels.attente')); ?>" class="btn btn-warning btn-sm">Personnel en Attente</a>
    <a href="<?php echo e(route('personnels.formation')); ?>" class="btn btn-info btn-sm">Personnel en Formation</a>
  </div>
</div>
    <div class="card">
      <div class="card-body">
        <a href="<?php echo e(route('personnels.index')); ?>" class="btn btn-success btn-sm">Tout le Personnel</a>
        <form action="<?php echo e(route('personnels.index')); ?>" methode="GET" style="display: inline-flex;">
        ...
        <a href="<?php echo e(route('personnels.import')); ?>" class="btn btn-info btn-sm float-right">
          Charger BD<i class="fa fa-upload" aria-hidden="true"></i>
        </a>
          ...
          <tbody>
            <?php $__currentLoopData = $personnels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $personnel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                  <a href="<?php echo e(route('pdfom',[$personnel->id])); ?>" class=""><i class="fa fa-download"></i></a>
                </td>
                <td>
                  ...
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_personnels')): ?>
                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['personnels.destroy', $personnel->id] ,'style'=>'display:inline-block !important;margin:0;','onsubmit'=>'return show_alert();']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin',['title'=>'Liste de personnels ('.$stat['total_personnels'].')' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/6ec092764b90fcd42777971432306baa/sites/recensement-2021.com/resources/views/admin/personnels/index.blade.php ENDPATH**/ ?>