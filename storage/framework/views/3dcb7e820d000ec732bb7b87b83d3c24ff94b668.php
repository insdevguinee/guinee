		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 text-center">
					<p style="margin-bottom: 5px; font-size: 12px;"><strong>REPUBLIQUE DE CÔTE D'IVOIRE</strong></p><div class="clearfix"></div>
					<div class="logo">
						<img src="<?php echo e(asset('/img/am.jpg')); ?>" style="height: 70px">
					</div>
					<p style="margin-bottom: 5px; font-size: 12px;">Union - Discipline - Travail</p>
			...
			<div class="row" style="margin-top: 20px;">
				<div class="col-12">
					<div class="section">
						<img src="<?php echo e(asset('/img/logo.png')); ?>" style="float: left; width:200px;" ><br>
					</div>
					<div class="section">
			...
			<div class="row">
				<div class="col-12">
					<p><strong>Le Coordonnateur Technique</strong> <strong style="float: right;">Abidjan, le 14 Octobre 2021</strong></p> <br>
					...
					<p><strong>N°00<?php echo e(@$personnel->id); ?>/INS/RP-21/DN/CT</strong></p>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					<div class="text-center">
						<H4 style="font-weight: 700;margin-bottom: 0px;"><u>ORDRE DE MISSION</u></H4>
						<p style="margin-top: 0;">CÔTE D'IVOIRE</p><br>
					</div>
					<div>
						<p><strong>Le Coordonnateur Technique du Recensement de la Population 2021 </strong>donne l’ordre à :</p><br>
					</div>
				</div>
			</div>
			<div class="row">
					...
					<table style="width: 100%;">
						<tbody>
							...
							<tr>
								...
								<td>: 14 OCTOBRE 2021</td>
							</tr>
							<tr>
								<th>DATE DE RETOUR</th>
								<td>: 02 NOVEMBRE 2021</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>: Recensement de la Population 2021</td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div class="row">
			  ...
			  <div class="text-center float-right">
						...
						<img src="<?php echo e(asset('img/signct.png')); ?>" alt="" style="width: 300px;margin-top: 10px"> <br>
				...
				<div class="col-12">
					<br><br><br><p style="float: right;"><strong>AKA DORE</strong></p> <br>
					<br>
					<br>
				</div>
			</div>
			<div class="row" style="display: block;position: fixed;width: 100%;bottom: 10px;border-top: double 2px black;">
				<div class="col-12">
					<p class="text-center">Siège : Cocody, 2 Plateaux vallon – Tel : 27 22 54 95 15 / 27 22 54 95 16 <br>
www.rgph.ci – Facebook : RGPH2021 – Twitter : Recensement2021
</p>
				</div>
			</div>
		</div>
...
</html><?php /**PATH /home/clients/6ec092764b90fcd42777971432306baa/sites/recensement-2021.com/resources/views/admin/personnels/ompdf.blade.php ENDPATH**/ ?>