...
<script>
  $(document).ready(function() {
    ...
    $('#deleteMotif').click(function() {
      ...
      var abs = $('#motif').attr('motif_id');
        $.ajax({
           url: "<?php echo e(route('formations.store')); ?>",
           type: 'POST',
           data: {
            'user': user_id,
            'date': year+'-'+month+'-'+day,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin',['title'=>'Gestion des abscences Formation' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/6ec092764b90fcd42777971432306baa/sites/recensement-2021.com/resources/views/admin/abscences/formation.blade.php ENDPATH**/ ?>