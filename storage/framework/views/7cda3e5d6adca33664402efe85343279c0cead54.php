          ...
          <tbody>
            <?php $__currentLoopData = $fournisseurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fournisseur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td> 
                <a href="#" title="Modifier" class="btn btn-info btn-sm">M<i class="fa fa-edit"></i></a>                  
...
<?php echo $__env->make('admin.layouts.admin',['title'=>'Liste de fournisseur' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/guinee/resources/views/admin/fournisseurs/index.blade.php ENDPATH**/ ?>