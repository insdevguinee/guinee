  ...
  <div class="col-md-12">
    ...
    <div class="card">
      <div class="card-body" style="background: aliceblue">
        <a href="<?php echo e(route('personnels.formation')); ?>" class="btn btn-success btn-sm">Effectif des Agents en Formation</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin',['title'=>'Effectif des Agents en formation ('.$stat['total_personnels'].')' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DIATAS\Desktop\DIATAS\INS\app\guinee\resources\views/admin/personnels/attente/formation.blade.php ENDPATH**/ ?>