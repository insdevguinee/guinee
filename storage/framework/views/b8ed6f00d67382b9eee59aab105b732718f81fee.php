...
<div class="row">
  <div class="col-md-12">
     <div class="card">
      <div class="card-body">
        <div class="col-12">
            <form action="<?php echo e(route('personnels.formation')); ?>" method="GET" class="input-group no-border">
    ...
    <div class="card">
      <div class="card-body" style="background: aliceblue">
        <a href="<?php echo e(route('personnels.formation')); ?>" class="btn btn-success btn-sm">Tout le Personnel en Formation</a>
        <form action="<?php echo e(route('personnels.formation')); ?>" methode="GET" style="display: inline-flex;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin',['title'=>'Liste de personnels en formation ('.$stat['total_personnels'].')' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/6ec092764b90fcd42777971432306baa/sites/recensement-2021.com/resources/views/admin/personnels/attente/formation.blade.php ENDPATH**/ ?>