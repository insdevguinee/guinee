  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        ...
        <a href="<?php echo e(route('fournisseurs.import')); ?>" class="btn btn-sm btn-info float-right" style="margin-left: 10px;"> Importer des Fournisseurs  </a>       
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            <?php $__currentLoopData = $fournisseurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fournisseur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td> <a href="<?php echo e(route('fournisseurs.edit',[$fournisseur->id])); ?>"> <?php echo e($fournisseur->codef); ?> </a> </td>
                <td><?php echo e($fournisseur->name); ?> </td>
                <td><?php echo e($fournisseur->contact); ?></td>                
                <td><?php echo e($fournisseur->email); ?></td>                
                <td><?php echo e($fournisseur->slug); ?></td>
                ...
                <td> 
                  <a href="<?php echo e(route('fournisseurs.edit',[$fournisseur->id])); ?>" title="Modifier" class="btn btn-info btn-sm">M<i class="fa fa-edit"></i></a>                  
...
if (isset($messageCache)) { $message = $messageCache; }
                ...
                <div class="form-group col-md-6" >  <label for="nom">Email</label>
                 ...
                 <input value="<?php echo e(old('email')); ?>" class="form-control  <?php if ($errors->has('email')) :
if (isset($message)) { $messageCache = $message; }
...
<?php echo $__env->make('admin.layouts.admin',['title'=>'Liste de fournisseur' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/diatas/Bureau/INS/app/guinee/resources/views/admin/fournisseurs/index.blade.php ENDPATH**/ ?>