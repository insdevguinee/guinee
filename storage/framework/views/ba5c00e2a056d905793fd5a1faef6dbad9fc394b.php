  ...
  <div class="col-md-12">
    ...
    <div class="row">
      <div class="col-12 float-right">
        <a href="<?php echo e(route('formations.index')); ?>" class="btn btn-info btn-sm">Agents en Formation</a>
        <a href="<?php echo e(route('abscences.index')); ?>" class="btn btn-success btn-sm">Agents en Activité</a>
      </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin',['title'=>'Gestion des Presences' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/diatas/Bureau/INS/app/guinee/resources/views/admin/abscences/index.blade.php ENDPATH**/ ?>