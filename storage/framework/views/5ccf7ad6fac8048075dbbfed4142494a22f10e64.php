      ...
      <div class="card card-stats">
        <div class="card-body alert-info " style="    border-radius: 12px;">
          <div class="row">
            ...
            <div class="col-7 col-md-8">
              <div class="numbers">
                <p class="card-category"><?php echo e($etat['credit'] - $etat['debit']); ?></p>
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_depenses')): ?>
        ...
        <?php endif; ?>
         ...
         <a href="<?php echo e(route('depenses.export')); ?>" type='button' class="btn btn-sm btn-info float-right">
        ...
        <table class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th>Imputation</th>
              <th>Libelle</th>
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_depenses')): ?>
              <th>DR</th>
              <?php endif; ?>
            ...
            <?php $__currentLoopData = $caisses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caisse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                ...
                <td>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_depenses')): ?>
                    <a href="<?php echo e(route('caisses.edit',[$caisse->id])); ?>" class="btn btn-sm btn-default" title="Modifier">M<i class="fa fa-edit"></i></a>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_depenses')): ?>
                      <?php echo Form::open(['method' => 'DELETE', 'route' => ['depenses.destroy', $caisse->id] ,'style'=>'display:inline-block !important;margin:0;','onsubmit'=>'return show_alert();']); ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo e(route('depenses.store')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="container">
              <div class="row">
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_portefeuilles')): ?>
  <div class="modal fade" id="addmontant">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo e(route('portefeuilles.store')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <div class="container">
              <div class="row">
...
$message = $errors->first('montant'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" type="number" name="montant" id="montant"> 
                    <?php if ($errors->has('montant')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('montant'); ?>
                        <span class="invalid-feedback" role="alert">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin',['title'=>'Gestion de depense'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/diatas/Bureau/INS/app/guinee/resources/views/admin/depenses/index.blade.php ENDPATH**/ ?>