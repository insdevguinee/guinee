<meta charset="utf-8" />
  ...
  <title><?php echo e(config('app.name', 'UBF')); ?></title>
  ...
  <link href="<?php echo e(asset('admin/tl/tl.css')); ?>" rel="stylesheet" />
  <link rel="stylesheet" href="<?php echo e(asset('admin/css/style.css')); ?>">
  <?php echo $__env->yieldContent('style'); ?><?php /**PATH /home/clients/6ec092764b90fcd42777971432306baa/sites/recensement-2021.com/resources/views/admin/layouts/links/head.blade.php ENDPATH**/ ?>