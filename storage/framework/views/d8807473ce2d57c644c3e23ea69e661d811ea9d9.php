                ...
                <div class="form-group col-md-6" >  <label for="direction_id">Zone d'activité</label>
                 ...
                 <select name="direction_id" id="direction" class="form-control">
                  ...
                  <?php $__currentLoopData = $directions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $direction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <option value="<?php echo e($direction->id); ?>" <?php echo e(($personnel->direction_id == $direction->id)?'selected':' '); ?>><?php echo e($direction->libelle); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.admin',['title'=>'Modifier le personnel '.$personnel->matricule], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DIATAS\Desktop\DIATAS\INS\app\guinee\resources\views/admin/personnels/edit.blade.php ENDPATH**/ ?>