  ...
  <div class="col-md-12">
    ...
    <div class="card">
      <div class="card-body" style="background: cornsilk">
        <a href="<?php echo e(route('personnels.attente')); ?>" class="btn btn-success btn-sm">Tout le Personnel en attente</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.admin',['title'=>'Liste de personnels en attente ('.$stat['total_personnels'].')' ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/6ec092764b90fcd42777971432306baa/sites/recensement-2021.com/resources/views/admin/personnels/attente/index.blade.php ENDPATH**/ ?>