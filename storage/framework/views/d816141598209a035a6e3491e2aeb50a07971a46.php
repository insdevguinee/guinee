...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
  ...
  <body>
    ...
    <div class="jumbotron mb-0 d-flex align-items-center flex-column justify-content-center text-center min-100" id="header" style="background-image: url(<?php echo e(asset('img/bg1.jpg')); ?>);background-size: cover;background-repeat: no-repeat;">
...
if (isset($messageCache)) { $message = $messageCache; }
       ...
       <div class="row mt-4">
            <div class="col-md-12">
              <h4></h4>
              <div id="partenaire">
                <img src="<?php echo e(asset('img/partenaires/logo_1.jpeg')); ?>" style="height: 50px;border-radius: 10px;">
              </div>
              <div class="text-white">
                <?php echo $__env->make('admin.layouts.us', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
              </div>
            </div>
          </div>
...
</html><?php /**PATH /home/clients/6ec092764b90fcd42777971432306baa/sites/recensement-2021.com/resources/views/auth/login.blade.php ENDPATH**/ ?>