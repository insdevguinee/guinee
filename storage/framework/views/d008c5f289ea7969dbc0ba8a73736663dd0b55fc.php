            ...
            <ul class="navbar-nav float-left">
              <li class="nav-item <?php echo e(active(route('admin'),'active')); ?>"><a href="<?php echo e(route('admin')); ?>" class="nav-link">Accueil</a></li>
               <li class="nav-item btn-rotate dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="Gestion">
                  ...
                  <hr style="margin: 0;">
                  <a class="dropdown-item" href="<?php echo e(route('personnels.import')); ?>">Ajouter du personnel</a>
              ...
              <li class="nav-item btn-rotate dropdown">
               ...
               <li class="nav-item btn-rotate dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="paiement">
                  ...
                  <a href="<?php echo e(route('paies.index')); ?>"  class="dropdown-item">Personnel Actif</a>
              ...
              <li class="nav-item btn-rotate dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="admin">
                  ...
                  <a class="dropdown-item" href="<?php echo e(route('directions.index')); ?>">Sous Préfecture</a>
                   <hr style="margin: 0;">
...
<?php /**PATH C:\laragon\www\guinee\resources\views/admin/layouts/links/navbar.blade.php ENDPATH**/ ?>