	...
	<body>
		<div class="container-fluid">
			<div class="row">
				<div class="col-3">
					...
					<h4 class="col-8 float-right">
						ETAT DES AGENTS RECENSEURS DANS LE CADRE DU RECENSEMENT DE LA POPULATION <?php echo e($infos['annee']); ?>
			...
			<div class="row" >
				...
				Objet : Formation des <?php echo e(@$users[0]['fonction']); ?>   <span class="text-uppercase"><?php echo e(@$infos['fonction']); ?></span> <br>
...
<?php /**PATH /Applications/MAMP/htdocs/recensement-2021.com/resources/views/admin/paies/pdf.blade.php ENDPATH**/ ?>